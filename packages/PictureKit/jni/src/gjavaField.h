...
static jfieldID gdecoderInfo_originImageWidthID;
static jfieldID gdecoderInfo_originImageHeightID;
static jfieldID gdecoderInfo_outImageWidthID;
static jfieldID gdecoderInfo_outImageHeightID;
