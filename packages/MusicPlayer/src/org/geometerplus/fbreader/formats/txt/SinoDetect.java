...
public class SinoDetect {
    ...
    static final int UTF7 = 10;
    static final int TOTAL_ENCODINGS = 11;
    ...
    public SinoDetect() {
        ...
        nicename[ISO_2022_CN] = "ISO-8859-1"; //ISO 2022-CN";
        nicename[UTF8] = "UTF-8";
        nicename[UNICODE] = "UTF-16";
        nicename[ASCII] = "US-ASCII";
        nicename[OTHER] = "windows-1252";
	 nicename[UTF7] = "UTF7";
...
//        System.out.println(nicename[result]);
    ...
    public int detectEncoding(File testfile) {
        ...
        int size = (int) Math.min(testfile.length(), 4096);
    ...
    int iso_2022_cn_probability(byte[] rawtext) {
        ...
        // System.out.println("isochars dbchars isofreq totalfreq " + isochars + " " + dbchars + " "
        // + isofreq + " " + totalfreq + " " + rangeval + " " + freqval);
    ...
    int utf16_probability(byte[] rawtext) {
         ...
         * (rawtext[i+2] & (byte)0xBF) == rawtext[i+2]) { goodbytes += 3; i+=2; } } } score =
         * (int)(100 ((float)goodbytes/(float)rawtext.length)); // An all ASCII file is also a good
         * UTF8 file, but I'd rather it // get identified as ASCII. Can delete following 3 lines
         * otherwise if (goodbytes == asciibytes) { score = 0; } // If not above 90, reduce to zero
         * to prevent coincidental matches if (score > 90) { return score; } else { return 0; }
         */
